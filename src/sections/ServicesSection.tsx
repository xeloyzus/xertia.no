...
const services = [
  {
    ...
    description: 'Desktop, web, and full-stack development — clean, maintainable code from prototype to production.',
    image: './code_card.jpg',
    icon: Code,
    color: '#3B82F6',
  },
  {
    ...
    description: 'Native and cross-platform mobile apps built for real-world use and performance.',
    image: './apps_card.jpg',
    icon: Smartphone,
    color: '#10B981',
  },
  {
    ...
    description: 'Custom model training and tooling, from computer vision to NLP to predictive analytics.',
    image: './ai_card.jpg',
    icon: Brain,
    color: '#8B5CF6',
  },
  {
    ...
    description: 'Model Context Protocol servers and AI integrations that connect models to your data and tools.',
    image: './mcp_card.jpg',
    icon: Network,
    color: '#F59E0B',
  },
  {
    ...
    title: 'Robotics',
    subtitle: 'Automation',
    description: 'Robot policy training and simulation with IsaacLab, Isaac Sim, and MuJoCo.',
